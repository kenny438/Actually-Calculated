                ...
                {shortcuts.map((shortcut) => (
                  ...
                  >
                    <div className="flex items-center gap-4 text-slate-600 group-hover:text-slate-900 font-bold text-lg">
                      <div className="p-2.5 bg-slate-100 rounded-xl group-hover:bg-bg-inverted-hover group-hover:shadow-sm transition-all border border-transparent group-hover:border-slate-200">
                        {shortcut.icon}
                      </div>
                      {shortcut.label}
                    </div>
